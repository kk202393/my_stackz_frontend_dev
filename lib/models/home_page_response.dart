...
class HomePageResponse {
  ...
  HomePageResponse.fromJson(Map<String, dynamic> json){
    ...
    allCategories = List.from(json['allCategories']).map((e)=>AllCategories.fromJson(e)).toList();
    timeSlot = List.from(json['timeSlot']).map((e)=>TimeSlot.fromJson(e)).toList();
  }
...
class Subcategories {
  ...
  Subcategories.fromJson(Map<String, dynamic> json){
    ...
    V = json['__v'];
    serviceCategory = List.from(json['serviceCategory']).map((e)=>ServiceCategory.fromJson(e)).toList();
  }
